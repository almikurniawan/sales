            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  (storeId>0) ? 
                  Text("Toko "+storeName, style: TextStyle(fontWeight: FontWeight.bold ), ) 
                  : 
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Text("Scan Toko terlebih dahulu !.", style: TextStyle(color: Colors.white),),
                    ),
                  ),
                  Container(
                            ...
                            if (state is PosProductLoaded) {
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Total Payment : Rp. " + format.format(total),
                                    style:
